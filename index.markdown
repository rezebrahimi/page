...
<div class="wrapper" style="border-bottom: 1px solid $black <!--$grey-color-->; border:4px; height:380px; overflow:auto;">
	<ul class="awards" style="margin-bottom: -5px">
		...
		<li>Our paper, on <a style="color:blue;text-decoration-line: underline;" href="https://ieeexplore.ieee.org/document/9474314"> Binary Black-box Malware Attacks</a> was accepted at <b>IEEE S&P</b> Workshop on Deep Learning and Security (DLS) 2021.</li>
